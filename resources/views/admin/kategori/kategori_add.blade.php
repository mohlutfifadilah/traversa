                                ...
                                <form method="POST" action="{{ route('kategori.store') }}">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                                ...
                                                <input class="form-control @if(session('nama_kategori')) is-invalid @endif @error('nama_kategori') is-invalid @enderror" type="text" id="nama_kategori" name="nama_kategori" value="" placeholder="" />
                                                @error('nama_kategori')
